...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'Add' || $_POST["action"] == 'Update')
	{
        ...
        {
            if($player_name==""){
                $output["player_name_error"] = "Please fill the player_name field...";
            }
            if($date==""){
			...
			if($_POST['action'] == 'Add')
			{
				$query = "INSERT INTO goalkeepers_table (PLAYERNAME, DATEOFBIRTH, NATIONALITY, EMAIL, INJURYHISTORY, ISINJURED, HEIGHT, WEIGHT,DIVING,HANDLING,KICKING,REFLEXES,SPEED,POSITIONING,COMMUNICATIONSKILLS,LEADERSHIPSKILLS,PAGELINK,IMAGELINK,SRCID,POSITION,PLAYERNUMBER) 
						  VALUES (:player_name, :date,:nationality,:email,:injury_his,:is_injured,:height,:weight,:diving,:handling,:kicking,:reflexes,:bilal,:positioning,:com_skills,:leader_skills,:pge,:image_link,:src,:position,:playerNO)";
