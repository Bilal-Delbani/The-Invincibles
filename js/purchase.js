...
function checkForPurchase(){
  ...
  var dump = document.getElementById("add_cart").innerHTML;
...
//and then send them to updateDB page to enter the data in the system
  var shoes = document.getElementById("Shoes 2024").innerHTML;
  var ball = document.getElementById("Champions Ball 2024").innerHTML;
