...
<div class="modal" id="customer_modal" tabindex="-1" style="overflow:scroll;">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="position" id="position" class="form-control" value="Attacker" readonly/>
...
<div class="modal-backdrop fade show" id="modal_backdrop" style="display:none;"></div>
    ...
    <script>
        ...
        function reset_data() {
            ...
            _('modal_title').innerHTML = 'Add Attacker';
...
fetch('actiondefenders.php', {
    ...
    if (responseData.success) {
        ...
        table.update();
        setTimeout(function() {
            window.location.href = 'manager_attacker.php';
        }, 1000);
    }
    else {
        ...
        function fetch_data(id) {
            ...
            fetch('actiondefenders.php', {
                ...
                _('modal_title').innerHTML = 'Edit Attacker';
