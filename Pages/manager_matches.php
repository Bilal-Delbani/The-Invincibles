...
<script>
    ...
    <link rel="icon" href="../images/png/football.png">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="customer_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php echo fetch_all_matches($connect); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
...
<div class="modal-backdrop fade show" id="modal_backdrop" style="display:none;"></div>
    ...
    <script>
        ...
        function reset_data() {
            ...
            _('modal_title').innerHTML = 'Add Match';
        ...
        _('action_button').onclick = function () {
            ...
            fetch('actionmatches.php', {
                ...
                if (responseData.success) {
                    ...
                    table.update();
                    setTimeout(function() {
                        window.location.href = 'manager_matches.php';
                    }, 1000);
        ...
        function fetch_data(id) {
            ...
            fetch('actionmatches.php', {
                ...
                _('modal_title').innerHTML = 'Edit Match';
